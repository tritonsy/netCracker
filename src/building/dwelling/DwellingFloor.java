...
public class DwellingFloor extends Flat {
    ...
    public DwellingFloor(Flat... flatArray) {
    ...
    public void addSpace(int prefFlatNumber, Flat newFlat) {
        Flat[] tmp = new Flat[this.arrayOfFlats.length + 1];
